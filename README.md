...
* Becuase I made the module fully collapse when no text is present, you will want to set any margins explicitly in your message or in `custom.css` if you want them.
